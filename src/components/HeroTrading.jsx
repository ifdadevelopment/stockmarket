...
export default function HeroTrading({
  ...
  return (
    <section className="relative overflow-hidden">
      {/* Right-side pale band sized to 40% on large screens */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 right-0 w-full lg:w-[40%] bg-slate-50"
      />
      {/* Vertical divider for large desktops */}
      <div
        aria-hidden="true"
        ...
        <div className="flex flex-col lg:flex-row lg:min-h-[440px] gap-10 lg:gap-12">
          ...
          <div className="lg:basis-3/5 flex items-center">
            <div className="max-w-2xl">
              <p className="text-sky-700 font-semibold tracking-wide text-base">
                Learn with Ease
              </p>

              <h1 className="mt-2 text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight">
