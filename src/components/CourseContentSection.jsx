...
const PRIMARY = "#1155FF"; // brand blue (adjust as needed)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr,2fr] gap-10 lg:gap-14 items-start">
        ...
        <div>
          ...
          <p className="mt-6 text-slate-600 leading-7">
            ...
            <span className="font-semibold">class includes practical activities</span> to ensure
        ...
        {/* Right: elevated panel with grid */}
        <div
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 border-b md:border-b md:border-r border-slate-200">
              <h3 className="text-lg font-extrabold text-slate-900">Basics of Share Trading</h3>
            ...
            <div className="p-8 border-b border-slate-200">
              <h3 className="text-lg font-extrabold text-slate-900">Technical Analysis</h3>
              <p className="mt-2 text-slate-600 leading-7">
            ...
            {/* Row 2 */}
            <div className="p-8 border-b md:border-b md:border-r border-slate-200">
              <h3 className="text-lg font-extrabold text-slate-900">Swing Trading Techniques</h3>
              <p className="mt-2 text-slate-600 leading-7">
            ...
            <div className="p-8 border-b border-slate-200">
              <h3 className="text-lg font-extrabold text-slate-900">Intraday Strategies</h3>
              <p className="mt-2 text-slate-600 leading-7">
            ...
            <div className="p-8 md:border-r border-slate-200">
              <h3 className="text-lg font-extrabold text-slate-900">Option Chain Analysis</h3>
              <p className="mt-2 text-slate-600 leading-7">
            ...
            <div className="p-8">
              <h3 className="text-lg font-extrabold text-slate-900">Option Trading Strategies</h3>
              <p className="mt-2 text-slate-600 leading-7">
