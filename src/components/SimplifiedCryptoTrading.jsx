...
const features = [
  {
    ...
    description: "Easily link your accounts and get started with seamless trading.",
    icon: <FaRegHandshake className="text-4xl text-white" />, 
  },
  {
    title: "Explore Markets",
    description: "Access a wide range of markets and explore opportunities globally.",
    icon: <FaChartLine className="text-4xl text-white" />, 
  },
  {
    title: "Analyze Trends",
    description: "Stay ahead of the curve with real-time market trend analysis.",
    icon: <FaRegArrowAltCircleRight className="text-4xl text-white" />, 
  },
  {
    title: "Execute Trades",
    description: "Quickly execute trades with a few clicks using our intuitive platform.",
    icon: <FaExchangeAlt className="text-4xl text-white" />, 
  },
];

export default function SimplifiedCryptoTrading() {
  return (
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold animate__animated animate__zoomIn">
            Simplified Crypto Trading with <span className="text-white">Tradeohedge</span>
          </h2>
          <p className="text-lg mt-4">Trade smarter with the tools and resources from Tradeohedge to make your crypto trading effortless and efficient.</p>
        </div>
