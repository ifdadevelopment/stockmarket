  ...
  return (
    <section className="bg-black text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        <p className="mt-4 text-center text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
          {intro}
        </p>
        ...
        <div className="mt-8 sm:mt-10 rounded-lg bg-white text-gray-900 shadow-lg ring-1 ring-black/5 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 sm:p-8">
            ...
            <div className="flex items-center justify-center">
              {/* Prefer exact aspect ratio like screenshot */}
              <img
                src={
                  illustration ||
                  "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format" // placeholder
                }
