        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-6 rounded-lg border border-white/10 bg-white/5 p-4 text-sm text-gray-300">
              ...
              <p className="mt-2 leading-6 text-[16px] sm:text-[18px] font-bold">
                Tradeohedge is a <span className="font-bold text-white">
                SEBI Registered Research Analyst</span> providing only research
                and advisory services.
              </p> */}

              <p className="mt-3 text-lg sm:text-xl font-extrabold text-white">
                We do NOT:
              </p>

              <ul className="mt-2 list-disc list-inside space-y-1 text-gray-300 text-[16px] sm:text-[18px] font-bold">
                <li>Handle client funds or trading accounts</li>
                <li>Provide Portfolio Management Services (PMS)</li>
                <li>Offer profit-sharing, assured returns, or capital guarantees</li>
              </ul>

              <p className="mt-3 leading-6 text-gray-400 text-[16px] sm:text-[18px] font-bold">
                Any person claiming otherwise is acting illegally and without authorization.
              </p>
            </div>
